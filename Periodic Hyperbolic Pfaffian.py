...
# #Modifying the graph with Fisher construction
    ...
    for i in range(cmax(n,g-1)+1,cmax(n,g)+1):
        if Vertices[i - 1][-2] == 0:
            ...
            B1, B2 ,B3= [], [], [] #Is to be changed to triangular modification and put in periodic boundary condtition
                ...
                if Vertices[j-1][-2]==0:
                    ...
                    if j==fl(i, g):
                        ...
                        if j==i:
                            ...
                            if j>cmax(n,g-1):
                                B1 += [0,0,0]
                                B2 += [0,0,0]  #Need to modify in order to incorporate the periodic boundary 
                                B3 += [0,0,0]
                            else:
                                B1 += [0,0,0]
                                B2 += [0,0,0]
